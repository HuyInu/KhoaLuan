<div id="leftInfo" class="hide_left_Info" style="width:430px" >
    ...
    <div class="body-container">
        <div class="general-information">
            <div class="head-gi">
                <h3><span class="TenPhuongXa"></span> - <span class="TenQuanHuyen"></span></h3>
            </div>
            <div class="body-gi">
                <div class="item-gi">
                    <i class="fas fa-vector-square text-info"></i> Diện tích: <span class="font-bold DienTich"></span>
                    <b>m<sup>2</sup></b>
                </div>
                <div class="item-gi">
        ...
        <div class="detailed-information">
            <div class="head-ttqh">
                <h3 class="text-danger font-bold">Thông tin quy hoạch</h3>
            </div>
