...
@section('head')
    @include('Admin.QLHaTangKyThuat.CapNuoc.NhaMayNuoc.head')
@endsection
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <h4 class="card-title">Quản lý nhà máy nước</h4>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="table" class="display table table-striped table-hover" >
                    ...
                    <tbody>
                        @foreach($NhaMayNuoc_list as $item)
                        <tr>
                            <td>{{$item->Ten}}</td>
                            <td>{{$item->CongSuat}}</td>
...
@section('footer')
    @include('Admin.QLHaTangKyThuat.CapNuoc.NhaMayNuoc.foot') 
@endsection