            ...
            <div class="modal-body">
                <form id="Form" >
                    <div class="form-group" id="Ma-form-group">
                        <label for="largeInput">Mã loại dự án:</label>
                        <input type="text" class="form-control" id="MaLoaiDuAn" name="MaLoaiDuAn">
                    </div>
                    <div class="form-group" id="Ten-form-group">
                        <label for="largeInput">Tên loại dự án:</label>
                        <input type="text" class="form-control" id="TenLoaiDuAn" name="TenLoaiDuAn">
                    </div>
    ...
    <div class="modal-dialog" role="document" >
        <div class="modal-content">
            <div class="modal-header no-bd modal_main_head" style="color: white; background-color: #1269db;">
                <h5 class="modal-title">
                    <h2 id="modal_title" class="fw-mediumbold">
                    Sửa loại quy hoạch mã: </h2> <h2 id="MaLoaiDuAn_Old" class="fw-mediumbold"></h2> <p hidden id='rowID'></p>
                </h5>
                <button type="button" class="close modal_main_CloseBtn" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <form id="Edit_Form" >
                    <div class="form-group" id="MaEdit-form-group">
                        <label for="largeInput">Mã loại dự án:</label>
                        <input type="text" class="form-control" id="MaLoaiDuAn_Edit" name="MaLoaiDuAn_Edit">
                    </div>
                    <div class="form-group" id="TenEdit-form-group">
                        <label for="largeInput">Tên loại dự án:</label>
                        <input type="text" class="form-control" id="TenLoaiDuAn_Edit" name="TenLoaiDuAn_Edit">
                    </div>
                    <div class="modal-footer no-bd" style="margin-top: 1rem;">
