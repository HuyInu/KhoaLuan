...
function edit_row(OBJECTID, TenLoaiDatTheoDA,DienTich, HeSoSuDungDat, TangCaoXayDung, MatDoXayDung, DuAnQuyHoach, LoaiDatQHXD,idTable, rowID)
{
    const action = '<td> <div class="form-button-action">'+
    ...
    const rowContent = [OBJECTID, TenLoaiDatTheoDA, DienTich, HeSoSuDungDat, TangCaoXayDung, MatDoXayDung, DuAnQuyHoach, LoaiDatQHXD, action];
